...
\begin{itemize}
    \item Architecting smart glasses on Pi Zero 2 W with camera, mic, solar charging, 3D-printed enclosure; Google Gemini
...
\noindent
\textbf{Programming \& Web:} Python, C, C++, Java, MATLAB, Bash, Verilog/SystemVerilog, JavaScript, HTML/CSS, UI/UX Design \\[1pt]
